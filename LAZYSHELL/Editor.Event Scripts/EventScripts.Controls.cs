    ...
    public partial class EventScripts : NewForm
    {
        private void ControlDisassembleEvent()
        {
            ...
            switch (esc.Opcode)
            {
                ...
                case 0x9C:
                    ...
                    evtNameA1.Items.AddRange(Lists.Numerize(Lists.SoundNames)); evtNameA1.Enabled = true;
                    evtNameA1.DropDownWidth = 250;
                    //
                    evtNameA1.SelectedIndex = esc.Param1;
                    break;
                ...
                case 0xBD:
                    ...
                    //
                    evtNumA3.Value = (esc.Param1 * 2) + 0x7000;
                    evtNumA4.Value = (esc.Param2 * 2) + 0x7000;
                    break;
                case 0xD8:
                case 0xD9:
                case 0xDA:
        ...
        private void ControlAssembleEvent()
        {
            switch (esc.Opcode)
            {
                ...
                case 0xBD:
                    esc.Param1 = (byte)((evtNumA3.Value - 0x7000) / 2);
                    esc.Param2 = (byte)((evtNumA4.Value - 0x7000) / 2);
                    break;
                case 0xD8:
                case 0xD9:
                case 0xDA:
        ...
        private void ControlDisassembleAction()
        {
            ...
            switch (asc.Opcode)
            {
                ...
                case 0xBD:
                    ...
                    //
                    evtNumA3.Value = (asc.Param1 * 2) + 0x7000;
                    evtNumA4.Value = (asc.Param2 * 2) + 0x7000;
                    break;
                case 0xD8:
                case 0xD9:
                case 0xDA:
        ...
        private void ControlAssembleAction()
        {
            switch (asc.Opcode)
            {
                ...
                case 0xBD:
                    asc.Param1 = (byte)((evtNumA3.Value - 0x7000) / 2);
                    asc.Param2 = (byte)((evtNumA4.Value - 0x7000) / 2);
                    break;
                case 0xD8:
                case 0xD9:
                case 0xDA:
